...
def Ref():
    ...
    OverAllCost=math.ceil(OverAllCost)
...
status = Label(f2,font=('aria', 15, 'bold'),width = 16, text="-Author Hasaan",bd=2,relief=SUNKEN)
...
lblcus = Label(f1, font=( 'aria' ,16, 'bold' ),text="Name",fg="steel blue",bd=10,anchor='w')
...
btnrec=Button(f1,padx=16,pady=8, bd=10 ,fg="black",font=('ariel' ,16,'bold'),width=10, text="Reciept", bg="powder blue",command=Receipt)
btnrec.grid(row=8, column=0)
